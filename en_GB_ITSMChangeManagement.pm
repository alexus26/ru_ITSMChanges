...
sub Data {
    ...
    $Self->{Translation}->{'ITSM Changes'} = 'Управление изменениями';
    $Self->{Translation}->{'workorder'} = 'Задание';
    $Self->{Translation}->{'A change must have a title!'} = 'Изменение должно иметь наименование!';
    $Self->{Translation}->{'A condition must have a name!'} = 'Условие должно иметь наименование!';
    $Self->{Translation}->{'A template must have a name!'} = 'Шаблон должн иметь наименование!';
    $Self->{Translation}->{'A workorder must have a title!'} = 'Задание должно иметь наименование!';
    $Self->{Translation}->{'ActionExecute::successfully'} = 'Успешно';
    $Self->{Translation}->{'ActionExecute::unsuccessfully'} = 'Неуспешно';
    $Self->{Translation}->{'Add CAB Template'} = 'Добавить CAB шаблон';
    $Self->{Translation}->{'Add Workorder'} = 'Добавить задание';
    $Self->{Translation}->{'Add a workorder to the change'} = 'Добавить задание для изменения';
    $Self->{Translation}->{'Add new condition and action pair'} = 'Добавить новую связку условие-действие';
    $Self->{Translation}->{'Agent interface module to show the ChangeManager overview icon.'} = 'Интерфейса агента для отображения быстрого обзора ChangeManager';
    $Self->{Translation}->{'Agent interface module to show the MyCAB overview icon.'} = 'Интерфейса агента для отображения быстрого обзора MyCAB';
    $Self->{Translation}->{'Agent interface module to show the MyChanges overview icon.'} = 'Интерфейса агента для отображения быстрого обзора MyChanges';
    $Self->{Translation}->{'Agent interface module to show the MyWorkOrders overview icon.'} = 'Интерфейса агента для отображения быстрого обзора MyWorkOrders';
    $Self->{Translation}->{'CABAgents'} = 'CAB агенты';
    $Self->{Translation}->{'CABCustomers'} = 'CAB Клиенты';
    $Self->{Translation}->{'Change Overview'} = 'Обзор изменения';
    $Self->{Translation}->{'Change Schedule'} = 'Расписание изменения';
    $Self->{Translation}->{'Change involved persons of the change'} = 'Изменить задействованных в Изменении персон';
    ...
    $Self->{Translation}->{'ChangeHistory::ActionDeleteAll'} = 'Все действия условия (ID=%s) удалены';
    $Self->{Translation}->{'ChangeHistory::ActionExecute'} = 'Действие (ID=%s) выполняется: %s';
    $Self->{Translation}->{'ChangeHistory::ActionUpdate'} = '%s (Действие ID=%s): Новое: %s <- Old: %s';
    $Self->{Translation}->{'ChangeHistory::ChangeActualEndTimeReached'} = 'Изменение (ID=%s) достигло фактичемского времени окончания.';
    $Self->{Translation}->{'ChangeHistory::ChangeActualStartTimeReached'} = 'Изменение (ID=%s) достигло фактичемского времени начала.';
    ...
    $Self->{Translation}->{'ChangeHistory::ChangeAttachmentDelete'} = 'Удаленне вложения %s';
    $Self->{Translation}->{'ChangeHistory::ChangeCABDelete'} = 'CAB удаленных %s';
    $Self->{Translation}->{'ChangeHistory::ChangeCABUpdate'} = '%s: Новых: %s <- Старых: %s';
    $Self->{Translation}->{'ChangeHistory::ChangeLinkAdd'} = 'Связь для %s (ID=%s) добавлена';
    $Self->{Translation}->{'ChangeHistory::ChangeLinkDelete'} = 'Связь для %s (ID=%s) удалена';
    $Self->{Translation}->{'ChangeHistory::ChangeNotificationSent'} = 'Уведомление отослано %s (Event: %s)';
    $Self->{Translation}->{'ChangeHistory::ChangePlannedEndTimeReached'} = 'Изменение (ID=%s) достгло планируемого времени окончания.';
    $Self->{Translation}->{'ChangeHistory::ChangePlannedStartTimeReached'} = 'Изменение (ID=%s) достгло планируемого времени окончания.';
    $Self->{Translation}->{'ChangeHistory::ChangeRequestedTimeReached'} = 'Изменение (ID=%s) достигло необходимого времени.';
    $Self->{Translation}->{'ChangeHistory::ChangeUpdate'} = '%s: Новых: %s <- Старых: %s';
    ...
    $Self->{Translation}->{'ChangeHistory::ConditionUpdate'} = '%s (Условие ID=%s): Новых: %s <- Старых: %s';
    ...
    $Self->{Translation}->{'ChangeHistory::ExpressionUpdate'} = '%s (Выражения ID=%s): Новых: %s <- Старых: %s';
    $Self->{Translation}->{'ChangeNumber'} = 'Номер Изменения';
    $Self->{Translation}->{'Clear'} = 'Очистить';
    $Self->{Translation}->{'Condition Edit'} = 'Редактирование условия';
    $Self->{Translation}->{'Conditions'} = 'Условия';
    $Self->{Translation}->{'Create Change'} = 'Создать Условие';
    $Self->{Translation}->{'Create a change from this ticket!'} = 'Создать изменение из этой заявки';
    $Self->{Translation}->{'Delete Workorder'} = 'Удалить задание';
    ...
    $Self->{Translation}->{'Edit the workorder'} = 'Редактировать задание';
    $Self->{Translation}->{'Expression'} = 'Выражение';
    $Self->{Translation}->{'Full-Text Search in Change and Workorder'} = 'Полностекстовый поиск в изменениях и заданиях';
    $Self->{Translation}->{'ITSMCondition'} = 'Условие';
    $Self->{Translation}->{'ITSMWorkOrder'} = 'Задание';
    $Self->{Translation}->{'Link another object to the change'} = 'Связать другой объект с изменением';
    $Self->{Translation}->{'Link another object to the workorder'} = 'Связать другой объект с заданием';
    $Self->{Translation}->{'Move all workorders in time'} = 'Сместить все задание по времени';
    $Self->{Translation}->{'My CABs'} = 'Мои CAB';
    $Self->{Translation}->{'My Changes'} = 'Мои изменения';
    $Self->{Translation}->{'My Workorders'} = 'Мои задания';
    $Self->{Translation}->{'No XXX settings'} = 'Нет \'%s\' настроек';
    $Self->{Translation}->{'PIR (Post Implementation Review)'} = '';
    $Self->{Translation}->{'PSA (Projected Service Availability)'} = '';
    $Self->{Translation}->{'Please select first a catalog class!'} = 'Сначала выберите каталог!';
    $Self->{Translation}->{'Print the change'} = 'Печать изменения';
    $Self->{Translation}->{'Print the workorder'} = 'Печать задания';
    ...
    $Self->{Translation}->{'Set the agent for the workorder'} = 'Назначить агента на задание';
    $Self->{Translation}->{'Take Workorder'} = 'Принятие заданий';
    $Self->{Translation}->{'Take the workorder'} = 'Принять задание';
    $Self->{Translation}->{'Template Overview'} = 'Обзор шаблонов';
    $Self->{Translation}->{'Templates'} = 'Шаблоны';
    $Self->{Translation}->{'The planned end time is invalid!'} = 'Некорректная запланированная дата окончания';
    $Self->{Translation}->{'The planned start time is invalid!'} = 'Некорректная запланированная дата начала';
    $Self->{Translation}->{'The planned time is invalid!'} = 'Некорректное запланированное время';
    $Self->{Translation}->{'The requested time is invalid!'} = 'Некорректное необходимое время';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReached'} = 'Время задания (ID=%s) достигло фактического времени окончания.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReachedWithWorkOrderID'} = 'Время задания (ID=%s) достигло фактического времени окончания.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReached'} = 'Время задания (ID=%s) достигло фактического времени начала.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReachedWithWorkOrderID'} = 'Время задания (ID=%s) достигло фактического времени начала.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAdd'} = 'Новые задания (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAddWithWorkOrderID'} = 'Новые задания (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentAdd'} = 'Новые вложения для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentAddWithWorkOrderID'} = '(ID=%s) новых вложений для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentDelete'} = 'Удаленные вложения для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentDeleteWithWorkOrderID'} = '(ID=%s) Удаленных вложений для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderReportAttachmentAdd'} = 'Новые вложения для отчетов: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderReportAttachmentAddWithWorkOrderID'} = '(ID=%s) Новых отчетов для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderReportAttachmentDelete'} = 'Удаленные прикрепленные отчеты для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderReportAttachmentDeleteWithWorkOrderID'} = '(ID=%s) Удаленных прикрепленных отчетов для задания: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderDelete'} = 'Задание (ID=%s) удалено';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderDeleteWithWorkOrderID'} = 'Задание (ID=%s) удалено';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderLinkDeleteWithWorkOrderID'} = '(ID=%s) Связь для %s (ID=%s) добавлена.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderNotificationSent'} = 'Уведомление направлено для %s (Событие: %s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderNotificationSentWithWorkOrderID'} = '(ID=%s) Уведомление направлено для %s (Событие: %s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReached'} = 'Время задания (ID=%s) достигло запланированного времени окончания.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReachedWithWorkOrderID'} = 'Время задания(ID=%s) достигло запланированного времени окончания.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReached'} = 'Время задания (ID=%s) достигло запланированного времени начала.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReachedWithWorkOrderID'} = 'Время задания (ID=%s) достигло запланированного времени начала.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderUpdate'} = '%s: Новых: %s <- Устаревших: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderUpdateWithWorkOrderID'} = '(ID=%s) %s: Новых: %s <- Устаревших: %s';
    $Self->{Translation}->{'WorkOrderNumber'} = 'Номер задания';
    $Self->{Translation}->{'accepted'} = 'Принято';
    $Self->{Translation}->{'any'} = 'Любое';
    $Self->{Translation}->{'approval'} = 'Утверждение';
    $Self->{Translation}->{'approved'} = 'Утверждено';
    $Self->{Translation}->{'backout'} = 'План отката';
    $Self->{Translation}->{'begins with'} = 'Начинает с';
    $Self->{Translation}->{'canceled'} = 'Отменено';
    $Self->{Translation}->{'contains'} = 'Содержит';
    $Self->{Translation}->{'created'} = 'Создано';
    $Self->{Translation}->{'decision'} = 'Решение';
    $Self->{Translation}->{'ends with'} = 'Заканчивается на';
    $Self->{Translation}->{'failed'} = 'Неуспешно';
    $Self->{Translation}->{'in progress'} = 'В процессе';
    $Self->{Translation}->{'is'} = 'равно';
    $Self->{Translation}->{'is after'} = 'после';
    $Self->{Translation}->{'is before'} = 'перед';
    $Self->{Translation}->{'is empty'} = 'пустое';
    $Self->{Translation}->{'is greater than'} = 'больше чем';
    $Self->{Translation}->{'is less than'} = 'меньше чем';
    $Self->{Translation}->{'is not'} = 'не';
    $Self->{Translation}->{'is not empty'} = 'не пустое';
    $Self->{Translation}->{'not contains'} = 'не содержит';
    $Self->{Translation}->{'pending approval'} = 'Ожидает утверждения';
    $Self->{Translation}->{'pending pir'} = 'Ожидающие PIR';
    $Self->{Translation}->{'pir'} = 'PIR (Обзор проведенного изменения)';
    $Self->{Translation}->{'ready'} = 'Готово';
    $Self->{Translation}->{'rejected'} = 'Отклонено';
    $Self->{Translation}->{'requested'} = 'Запрошено';
    $Self->{Translation}->{'retracted'} = 'Отозвано';
    $Self->{Translation}->{'set'} = 'Установить';
    $Self->{Translation}->{'successful'} = 'Успешно';

    # Template: AdminITSMChangeCIPAllocate
    $Self->{Translation}->{'Category <-> Impact <-> Priority'} = 'Категория <-> Влияние <-> Приоритет';
    $Self->{Translation}->{'Note'} = 'Заметка';
    $Self->{Translation}->{'Manage the priority result of combinating Category <-> Impact.'} = 'Управление приоритетами в помощью комбинации Категория <-> Влияние';
    $Self->{Translation}->{'Priority allocation'} = 'Распределение приоритетов';
